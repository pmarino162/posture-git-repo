...
%% Setup saveFig   
    saveFig = false;
    saveDir = 'C:\Users\pmari\OneDrive - University of Pittsburgh\Documents\Postdoc applications\Job Talk\Posture Hypotheses';
...
%Get disorganized axis lims and ticks
figure; hold on;
xDim = 3; yDim = 2; zDim = 1;
for posture = postureList
    for target = targetList
...
for posture = postureList
    ...
    if saveFig
        saveas(gcf,fullfile(saveDir,['disOrgHypP',num2str(posture),'.svg']));
    end
end
