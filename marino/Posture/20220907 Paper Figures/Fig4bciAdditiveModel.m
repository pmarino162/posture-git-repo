...
%% Construct resultStruct for multiple sessions
    ...
    %Nigel BCI
    inputStruct(4).dataset = 'N20171215'; inputStruct(4).task = 'BCI'; inputStruct(4).epoch = 'all';
    inputStruct(5).dataset = 'N20180221'; inputStruct(5).task = 'BCI'; inputStruct(5).epoch = 'all';

    %Rocky BCI
    inputStruct(1).dataset = 'R20201020'; inputStruct(1).task = 'BCI'; inputStruct(1).epoch = 'all';
...
%% Create R2 Scatter
    ...
    for monkey = {'E','N','R'}
       ...
       plot(monkeyInd,R2,'.','MarkerSize',20,'Color','b');
