...
%% Construct resultStruct for multiple sessions
    %Earl Reaching
    %inputStruct(1).dataset = 'R20200221'; inputStruct(1).task = 'Reach'; 
   inputStruct(1).dataset = 'E20210706'; inputStruct(1).task = 'Reach'; 
   inputStruct(2).dataset = 'E20210707'; inputStruct(2).task = 'Reach';
   inputStruct(3).dataset = 'E20210708'; inputStruct(3).task = 'Reach';
   
   %Nigel Reaching 
    inputStruct(4).dataset = 'N20190222'; inputStruct(4).task = 'Reach'; 
    inputStruct(5).dataset = 'N20190226'; inputStruct(5).task = 'Reach'; 
    inputStruct(6).dataset = 'N20190227'; inputStruct(6).task = 'Reach';
    inputStruct(7).dataset = 'N20190228'; inputStruct(7).task = 'Reach'; 

    %Rocky Reaching
    inputStruct(8).dataset = 'R20200221'; inputStruct(8).task = 'Reach'; 
    inputStruct(9).dataset = 'R20200222'; inputStruct(9).task = 'Reach';
...
%% Look at absolute model error
    figure; hold on
    monkeyInd = 1;
    for monkey = {'E','N','R'}
       tempResultStruct = resultStruct(strcmp(monkeyList,monkey{1,1}));
       noModelDist = [tempResultStruct.noModelDist];
    ...
    tempResultStruct = resultStruct(5);
