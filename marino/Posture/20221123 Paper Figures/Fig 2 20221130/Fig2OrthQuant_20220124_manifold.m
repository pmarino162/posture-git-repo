...
%% Setup saveFig   
    saveFig = false;
    saveDir = 'D:\Posture Paper\20221123\Figures\Figure 2\Alignment Indices\20230125\manifold';
...
%     task = 'reach';
    ...
    for datasetList = bciDatasetList%{'E20200116','E20200117'}
        %Load data
        ...
        for i = 1:numReps
            if numPdims == 2 && numTdims == 2
                v1 = normrnd(0,1,numManPCs,2);
                v2 = normrnd(0,1,numManPCs,2);
                DR = orth([v1,v2]);
