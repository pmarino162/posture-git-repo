...
%% Change Target
    ...
    for i = 1:10
        subplot(2,5,i)
        shadedErrorBar(cond1Time,cond1Traj(:,i),cond1CI(:,i),'lineprops',{'LineWidth',1.5,'Color','k'})
        hold on
        shadedErrorBar(cond2Time,cond2Traj(:,i),cond2CI(:,i),'lineprops',{'LineWidth',1.5,'Color',pcmap(1,:)})
    end
...
%     legend('Reference Trajectory','Change Target')
    if saveFig
       saveas(gcf,fullfile(saveDir,'UnshiftedPCATimecourseChangeTarget.jpg')); 
    end
    ...
    for i = 1:10
        ...
        shadedErrorBar(cond1Time,cond1Traj(:,i),cond1CI(:,i),'lineprops',{'LineWidth',1.5,'Color','k'})
        hold on
        shadedErrorBar(cond2Time,cond2ShiftTraj(:,i),cond2CI(:,i),'lineprops',{'LineWidth',1.5,'Color',pcmap(1,:)})
    end
...
%     legend('Reference Trajectory','Change Target')    
    if saveFig
       saveas(gcf,fullfile(saveDir,'ShiftedPCATimecourseChangeTarget.jpg')); 
    end    
...
%% Change Posture
    ...
    for i = 1:10
        ...
        shadedErrorBar(cond1Time,cond1Traj(:,i),cond1CI(:,i),'lineprops',{'LineWidth',1.5,'Color','k'})
        hold on
        shadedErrorBar(cond2Time,cond2Traj(:,i),cond2CI(:,i),'lineprops',{'LineWidth',1.5,'Color',pcmap(5,:)})
    end
...
%     legend('Reference Trajectory','Change Posture')
    if saveFig
       saveas(gcf,fullfile(saveDir,'UnshiftedPCATimecourseChangePosture.jpg')); 
    end
    ...
    for i = 1:10
        ...
        shadedErrorBar(cond1Time,cond1Traj(:,i),cond1CI(:,i),'lineprops',{'LineWidth',1.5,'Color','k'})
        hold on
        shadedErrorBar(cond2Time,cond2ShiftTraj(:,i),cond2CI(:,i),'lineprops',{'LineWidth',1.5,'Color',pcmap(5,:)})
    end
...
%     legend('Reference Trajectory','Change Posture')    
    if saveFig
       saveas(gcf,fullfile(saveDir,'ShiftedPCATimecourseChangePosture.jpg')); 
    end    
    ...
    switch task
        case {'BCI','reaching','planning','multijoint BCI'}
             for posture = plotPostureList
               for target = plotTargetList
                   ...
                   plot3(traj(1,1),traj(1,2),traj(1,3),'.','MarkerSize',10,'Color',pcmap(posture,:),'MarkerFaceColor',pcmap(posture,:));
                   plot3(traj(end,1),traj(end,2),traj(end,3),'>','MarkerSize',5,'Color',pcmap(posture,:),'MarkerFaceColor',pcmap(posture,:));
               end
             end
        ...
        case 'iso'
            for posture = plotPostureList
               for target = plotTargetList
                   traj = trajStruct([trajStruct.posture]==posture & [trajStruct.target]==target).avgPTOrth.traj(timePts,:); 
                   plot(traj(:,1),traj(:,2),'Color',pcmap(posture,:),'LineWidth',1.5);
                   plot(traj(1,1),traj(1,2),'.','MarkerSize',10,'Color',pcmap(posture,:),'MarkerFaceColor',pcmap(posture,:));
