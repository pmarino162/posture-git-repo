...
%% Setup saveFig   
    saveFig = true;
    saveDir = 'C:\Users\pmari\OneDrive - University of Pittsburgh\Documents\Posture\Paper\20230201\Fig 5\schematic';
...
grid on
if saveFig
    saveas(gcf,fullfile(saveDir,'t2.svg'));
end
...
grid on
if saveFig
    saveas(gcf,fullfile(saveDir,'t1.svg'));
end
