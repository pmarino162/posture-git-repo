...
%         end
        ...
        struct('animal',[],'dataset',[],'vPP',[],'vPT',[],'vTT',[],'vTP',[],'vPR',[],'vTR',[]);
...
%% Plot results
    ...
    for monkey = monkeyList
       ...
       for session = 1:numel(tempResultStruct)
           ...
           e = errorbar(1,vPPMean,vPPStd,'ok','LineWidth',2,'MarkerSize',2,'MarkerFaceColor','r');      
           e = errorbar(2,vPTMean,vPTStd,'ok','LineWidth',2,'MarkerSize',2,'MarkerFaceColor','r'); 
           e = errorbar(2.5,vPRMean,vPRStd,'ok','LineWidth',2,'MarkerSize',2,'MarkerFaceColor','r'); 
           plot([1,2,2.5],[vPPMean,vPTMean,vPRMean],'-k')
           
           e = errorbar(3.5,vTTMean,vTTStd,'ok','LineWidth',2,'MarkerSize',2,'MarkerFaceColor','r'); 
           e = errorbar(4.5,vTPMean,vTPStd,'ok','LineWidth',2,'MarkerSize',2,'MarkerFaceColor','r'); 
           e = errorbar(5,vTRMean,vTRStd,'ok','LineWidth',2,'MarkerSize',2,'MarkerFaceColor','r'); 
           plot([3.5,4.5,5],[vTTMean,vTPMean,vTRMean],'-k')
