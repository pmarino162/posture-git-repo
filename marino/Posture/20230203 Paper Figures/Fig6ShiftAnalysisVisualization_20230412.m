...
%% Run loop for each dataset
    ...
    %task = 'bci';
    task = 'reach';
    for datasetList = {'R20200221'}% reachDatasetList%{'E20210707','N20190226','R20200221'}%{'E20200316','N20171215','R20201020'}%{ 'R20200221'}%bciDatasetList%{'E20210706','E20210707','E20210708','E20210709'}%reachDatasetList
        %Load data
