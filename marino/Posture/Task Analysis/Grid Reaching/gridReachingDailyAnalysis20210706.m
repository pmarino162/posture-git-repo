...
%     savePath = 'C:\Users\pmari\OneDrive - University of Pittsburgh\Documents\Posture\Figures\Task Analysis\Grid Reaching';
    savePath = 'D:\Animals\Earl\2021\07\20210708\Daily Plots\';
    saveFig = true;
...
%             if target ~= 7
                text(textX,textY,[num2str(round(PTStats.sucPct)),'% ','(',num2str(PTStats.suc),'/',num2str(PTStats.total),')'...
                    newline,'MAT = ',num2str(round(PTStats.medianAcqTime))...
                    ...
                    newline,'LD ',num2str(round(PTStats.longDelaySucPct)),'% ','(',num2str(PTStats.longDelaySuc),'/',num2str(PTStats.longDelayTotal),')',...
                    ],'FontSize',5)
%             else
