...
%% Do LDA on all Data
    ...
    allPosture1Traj = allTraj([allPostureLabels==1],:);
    allPosture1TargetLabels = allTargetLabels([allPostureLabels==1],:);
    
    targetLDA = fisherLDA(allPosture1Traj, allPosture1TargetLabels);
