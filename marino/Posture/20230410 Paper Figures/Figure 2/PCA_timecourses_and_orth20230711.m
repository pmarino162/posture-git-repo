...
%% Setup saveFig   
    saveFig = true;
    saveDir = 'C:\Users\pmari\OneDrive - University of Pittsburgh\Documents\Posture\Paper\20230410\Figure 2\rapid iterations - 20230711\PC plots';
    ...
    for datasetList = {'E20200316'}%{'E20200317','E20200116','E20210706','N20171215','R20201020','N20190226','R20200221'}%{'R20200221'}%{'E20200317','E20200116','E20210706'}
       clf; close all
        ...
        for plotGroup = 1:2
            ...
            %Plot traces
            fs = 14;
            f = figure; f.Position = [50 50 500 1000];
            for posture = plotPostureList
                for target = plotTargetList
                    ...
                    for dim = 1:5
                        subplot(5,1,dim); hold on;
                        if target == 1
                            shadedErrorBar(time,traj(:,dim),CI(1:length(time),dim),'lineprops',{'LineWidth',5','Color',pcmap(posture,:)});
                        elseif target == 5
                            shadedErrorBar(time,traj(:,dim),CI(1:length(time),dim),'lineprops',{'--','LineWidth',5','Color',pcmap(posture,:)});
                        end
                    end
