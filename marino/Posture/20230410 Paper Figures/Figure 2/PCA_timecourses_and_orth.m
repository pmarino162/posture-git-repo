...
%% Run Loop    
    for datasetList = {'E20200317'}%{'E20200317','E20200116','E20210706','N20171215','R20201020','N20190226','R20200221'}%{'R20200221'}%{'E20200317','E20200116','E20210706'}
       clf; close all
        ...
        %Plot traces
        f = figure; f.Position = [50 50 1000 500];
        ...
        if saveFig
            saveas(gcf,fullfile(saveDir,task,'PC_traces.svg')); 
        end

        
        %Plot Orthographic View
        ...
        set(gca,'fontsize',fs)
        if saveFig
            saveas(gcf,fullfile(saveDir,[dataset,'_PCA.svg']));
        end
