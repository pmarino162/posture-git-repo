...
%% Run loop for each dataset
    ...
    for datasetList = {'E20200316'}%bciDatasetList% reachDatasetList%{'E20210707','N20190226','R20200221'}%{'E20200316','N20171215','R20201020'}%{ 'R20200221'}%bciDatasetList%{'E20210706','E20210707','E20210708','E20210709'}%reachDatasetList
        %Load data
...
%                 trialInclStates(1).inclStates = {{'state','Target','first',25},{'state','Target','first',300}};
                task = 'iso';
        end
...
%         
%         %Keep only targets 1 and 5
%         keepTarget = [1,5];
%         trajStruct = trajStruct(ismember([trajStruct.target],keepTarget));
