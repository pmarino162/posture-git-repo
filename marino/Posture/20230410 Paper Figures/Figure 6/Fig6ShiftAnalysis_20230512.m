...
%% Run loop for each dataset
    ...
    for datasetList = {'E20210706','E20210707','E20210708'}% reachDatasetList%{'E20210707','N20190226','R20200221'}%{'E20200316','N20171215','R20201020'}%{ 'R20200221'}%bciDatasetList%{'E20210706','E20210707','E20210708','E20210709'}%reachDatasetList
        %Load data
        ...
        switch dataset
            ...
            case {'E20200116','E20200117','E20200120'}
                ...
                condFields = {{'target','targetData','targetID'},{'posture','conditionData','postureID'}};
                trialInclStates(1).inclStates = {{'kin','moveOnsetTime','first',-250},{'kin','moveOnsetTime','first',-100}};
                task = 'iso';
        end
