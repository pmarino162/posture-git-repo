function [X,Y,Z] = error_ellipse_Patrick(data,pctCI)

%Takes as input data (must be 2 or 3d) and pct confidence interval (e.g., use pctCI = 95 for
%a 95% CI.  Outputs X,Y,Z.  For 2d data, X and Z allow you to draw error
