function [W,V,postureDims,targetDims,explVar,additionalVarExpl] = getPostureDPCADims_NoZScore(trajStruct,regularize,postureList,numPostures,targetList,numTargets,numChannels,minNumTimestamps)
        ...
        [X] = getX(trajStruct,'avgSmoothFR',minNumTimestamps,postureList,numPostures,targetList,numTargets);    
        ...
        if regularize
            ...
            [Xfull] = getXFull(trajStruct,'allSmoothFR',minNumTimestamps,postureList,numPostures,targetList,numTargets); 
