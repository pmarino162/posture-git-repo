...
%% Setup saveFig   
    saveFig = false;
    saveDir = "C:\Users\pmari\OneDrive\Documents\Posture\Paper\Reviewer responses\Analyses\z_scoring";
...
%% Main Loop  
    for datasetList = {'E20200318'}%{'E20200318','E20210901','E20200116','E20210706','N20171215','R20201020','N20190226','R20200221','E20210708'}
        ...
        %% Run dPCA
        [W,V,postureDims,targetDims,explVar,additionalVarExpl] = getPostureDPCADims_NoZScore(trajStruct,regularize,postureList,numPostures,targetList,numTargets,numChannels,minNumTimestamps);
        pDPCA = W(:,postureDims);
        tDPCA = W(:,targetDims);     
        ...
        for i = 1:size(trajStruct,2)
            ...
            trajStruct(i).dPCA.traj = trajStruct(i).avgSmoothFR.traj*W;
            %Get VAF
