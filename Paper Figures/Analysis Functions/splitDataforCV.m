function [trajStruct1,trajStruct2] = splitDataforCV(trajStruct,minNumCondTrials,binWidth)       
    ...
    for j = 1:size(trajStruct,2)
        ...
        [trajStruct1(j).avgPCA.traj,trajStruct1(j).avgPCA.timestamps,trajStruct1(j).avgPCA.CI95] = getAvgTraj(trajStruct1(j).allPCA,binWidth); 
        ...
        [trajStruct2(j).avgPCA.traj,trajStruct2(j).avgPCA.timestamps,trajStruct2(j).avgPCA.CI95] = getAvgTraj(trajStruct2(j).allPCA,binWidth); 
